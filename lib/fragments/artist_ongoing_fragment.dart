...
class ArtistOngoingFragment extends StatefulWidget {
  const ArtistOngoingFragment({super.key});

  @override
  State<ArtistOngoingFragment> createState() => _ArtistOngoingFragmentState();
}

class _ArtistOngoingFragmentState extends State<ArtistOngoingFragment> {
  late Future<ArtistHistory> artisthistoryfuture;
  Future<ArtistHistory> artistBooking() async {
    return ApiHelper.artistBooking('ONGOING');
  }
  @override
  void initState() {
